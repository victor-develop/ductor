...
from ductor_slack.cli.factory import create_cli
...
from ductor_slack.cli.types import AgentRequest, AgentResponse, CLIResponse

if TYPE_CHECKING:
    from ductor_slack.cli.base import BaseCLI
