...
from ductor_slack.app_identity import DEFAULT_DOCKER_CONTAINER, DEFAULT_DOCKER_IMAGE
...
from ductor_slack.config import DEFAULT_EMPTY_GEMINI_API_KEY, AgentConfig, deep_merge_config
...
def _build_extras_table(console: Console) -> None:
    ...
    from ductor_slack.infra.docker_extras import DOCKER_EXTRAS_BY_ID, extras_for_display
...
def _offer_service_install(console: Console) -> bool:
    ...
    from ductor_slack.infra.service import is_service_available
...
def run_onboarding() -> bool:
    ...
    if run_as_service:
        from ductor_slack.infra.service import install_service
