...
from ductor_slack.app_identity import DEFAULT_HOME_DIRNAME

# ductor_slack/workspace/paths.py -> ductor_slack/workspace -> ductor_slack
...
def resolve_paths(
    ...
    *,
    ...
    Args:
        ...
        home_defaults: Template directory. Falls back to ``ductor_slack/_home_defaults/``.
    """
