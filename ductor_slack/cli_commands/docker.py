...
from ductor_slack.app_identity import CLI_COMMAND, DEFAULT_DOCKER_CONTAINER, DEFAULT_DOCKER_IMAGE
...
def docker_extras_list() -> None:
    ...
    from ductor_slack.infra.docker_extras import extras_for_display
...
def docker_extras_add(args: list[str]) -> None:
    ...
    from ductor_slack.infra.docker_extras import DOCKER_EXTRAS_BY_ID
...
def docker_extras_remove(args: list[str]) -> None:
    ...
    from ductor_slack.infra.docker_extras import DOCKER_EXTRAS, DOCKER_EXTRAS_BY_ID
