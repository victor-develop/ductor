...
from ductor_slack.app_identity import CLI_COMMAND, DEFAULT_API_PORT, PACKAGE_NAME
from ductor_slack.config import _BIND_ALL_INTERFACES
...
def api_enable() -> None:
    ...
    from ductor_slack.cli_commands.docker import docker_read_config
