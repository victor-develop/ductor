...
from ductor_slack.infra.updater import perform_upgrade_pipeline, write_upgrade_sentinel
...
async def handle_changelog_callback(
    ...
    *,
    ...
    from ductor_slack.infra.version import _parse_version, fetch_changelog
