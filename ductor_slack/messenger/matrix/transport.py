...
from ductor_slack.bus.cron_sanitize import sanitize_cron_result_text
from ductor_slack.bus.envelope import Envelope, Origin
from ductor_slack.messenger.matrix.sender import MatrixSendOpts
...
class MatrixTransport:
    ...
    async def _broadcast(self, text: str) -> None:
        ...
        from ductor_slack.messenger.matrix.bot import resolve_broadcast_rooms
