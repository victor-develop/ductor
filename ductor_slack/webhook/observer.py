...
from ductor_slack.infra.task_runner import execute_in_task_folder
from ductor_slack.utils.quiet_hours import check_quiet_hour
from ductor_slack.webhook.models import WebhookResult, render_template
from ductor_slack.webhook.server import WebhookServer
...
class WebhookObserver(BaseTaskObserver):
    ...
    async def start(self) -> None:
        ...
        if not self._config.webhooks.token:
            from ductor_slack.config import update_config_file_async
