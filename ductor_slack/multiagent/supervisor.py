...
from ductor_slack.config import AgentConfig, update_config_file_async
from ductor_slack.infra.file_watcher import FileWatcher
...
from ductor_slack.multiagent.registry import AgentRegistry
from ductor_slack.multiagent.stack import AgentStack
...
if TYPE_CHECKING:
    ...
    from ductor_slack.multiagent.shared_knowledge import SharedKnowledgeSync
...
class AgentSupervisor:
    ...
    async def start(self) -> int:
        ...
        if self._main_config.docker.enabled and self._main_config.docker.extras:
            from ductor_slack.infra.docker_extras import calculate_build_timeout, resolve_extras
