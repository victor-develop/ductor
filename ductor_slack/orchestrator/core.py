...
from ductor_slack.app_identity import DEFAULT_INTERAGENT_PORT
from ductor_slack.background import (
    BackgroundSubmit,
    BackgroundTask,
)
...
from ductor_slack.infra.inflight import InflightTracker
...
from ductor_slack.orchestrator.directives import parse_directives
...
from ductor_slack.orchestrator.providers import ProviderManager
from ductor_slack.orchestrator.registry import CommandRegistry, OrchestratorResult
from ductor_slack.security import detect_suspicious_patterns
from ductor_slack.session import SessionKey, SessionManager
...
if TYPE_CHECKING:
    from ductor_slack.background import BackgroundObserver
...
class Orchestrator:
    ...
    async def create(
        ...
        *,
        ...
        """
        from ductor_slack.orchestrator.lifecycle import create_orchestrator
    ...
    def submit_named_session(
        ...
        from ductor_slack.cli.param_resolver import resolve_cli_config
    ...
    async def _ensure_docker(self) -> None:
        ...
        from ductor_slack.orchestrator.lifecycle import ensure_docker
    ...
    async def inject_prompt(
        ...
        *,
        ...
        from ductor_slack.orchestrator.injection import _inject_prompt
    ...
    async def shutdown(self) -> None:
        ...
        from ductor_slack.orchestrator.lifecycle import shutdown
