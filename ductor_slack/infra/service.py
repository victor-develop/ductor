...
if sys.platform == "win32":
    from ductor_slack.infra import service_windows as _backend
elif sys.platform == "darwin":
    from ductor_slack.infra import service_macos as _backend
else:
    from ductor_slack.infra import service_linux as _backend
